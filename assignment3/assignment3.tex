...
\item
GRU model has exploding gradients.
As shown in the figure above, the gradient suddenly shoots up to 8.
While with gradient clipping, the gradient has been kept below 5.
THe gradient clipping makes the model more stable.
